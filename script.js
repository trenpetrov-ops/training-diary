...
function prepareKeyboardDockedModal(overlay, host) {
    ...
    overlay.classList.add('keyboard-docked-modal-overlay');
...
function presentKeyboardDockedModal(overlay, host, options = {}) {
    ...
    requestAnimationFrame(() => {
        ...
        overlay.classList.add('keyboard-docked-modal-overlay--visible');
        host.classList.add('keyboard-docked-modal-host--visible');
    });
